# We can use this in any type of linux better try to run on Kali Linux
import subprocess
...
|  \/  |             |___  /            | |            
| \  / | __ _ ___ ___   / /_      ____ _| | _____ _ __ 
| |\/| |/ _` / __/ __| / /\ \ /\ / / _` | |/ / _ \ '__|
| |  | | (_| \__ \__ \/ /__\ V  V / (_| |   <  __/ |   
|_|  |_|\__,_|___/___/_____|\_/\_/ \__,_|_|\_\___|_|  """)

print("\n****************************************************")


# need to run as super user , otherwise don't allow
if not 'SUDO_UID' in os.environ.keys():
    print("Try running this program with sudo.")
    exit()

# Moving all .csv files to backup folder
...
# select the channel we want to perform the DOS attack on.
# Monitoring takes place on a different channel and we need to select that channel.
